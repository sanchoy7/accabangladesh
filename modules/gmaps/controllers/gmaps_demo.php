...
class Gmaps_Demo_Controller extends Controller {
	...
	public function index()
	{
		...
		// Add a new marker
		$map->add_marker(23.750514, 90.388061, '<strong>S@ifurs University College, 69/B,<br />Monowara Plaza, Green Road,<br />Panthopath, Dhaka-1205, Bangladesh.</strong><p>Welcome To S@ifurs University College.</p>', array('icon' => 'tinyIcon', 'draggable' => true, 'bouncy' => true));
		View::factory('gmaps/api_demo')->set(array('api_url' => Gmap::api_url(), 'map' => $map->render()))->render(TRUE);
	}

	public function image_map()
	{
		$points = array('23.750514' => '90.388061', '23.750586' => '90.387842', '0.002259' => '0.003449');
		View::factory('gmaps/static_demo')->set(array('simple' => Gmap::static_map(23.750514, 90.388061),'multi' => Gmap::static_map($points)))->render(TRUE);
	}
