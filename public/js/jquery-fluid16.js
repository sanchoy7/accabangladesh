...
Toggle : function(){
	...
	$.each(
		["grid", "paragraphs", "blockquote", "list-items", "section-menu", "voyger-ads", "student-care", "recent-ad", "testimonial", "notice-board", "tables", "forms", "login-forms", "search", "articles", "accordion"],
		function() {
