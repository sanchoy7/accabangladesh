/* MarcGrabanski.com */
/* Clean Calendar Built from Scratch by Marc Grabanski */
...
var popUpCal = {
    ...
    drawCalendar: function (inputObj) {
        ...
        var weekDays = new Array('S','S','M','T','W','T','F');
    ...
    setupLinks: function (inputObj){
        ...
        for (var i=0; i<x.length; i++){
            ...
            x[i].onclick = function(){
                ...
                inputObj.value = formatDate(popUpCal.selectedYear, popUpCal.selectedMonth, popUpCal.selectedDay);		
            }
        }
    }
